            ...
            <div className='lg:w-[60%]'>
                ...
                <div className='mt-2 md:mt-5 p-3 py-5 md:p-9 rounded-3xl md:rounded-4xl bg-blue-100'>
                    <div className='flex mb-4 w-fit shadow-xl shadow-blue-200 items-center border border-blue-200 rounded-full text-sm md:text-base bg-stone-50 overflow-hidden poppins-semibold text-stone-600'>
                        <div className='w-16 md:w-20 py-1 md:py-2 bg-blue-300 flex justify-center items-center'>
                            <img src={normal} alt="normal" className='w-5 md:w-8' />
                        </div>
                        <div className='px-3 md:px-5 flex items-center'>Affordable, Fast and Best</div>
                    </div>
                    <div className='lilita-one-regular text-5xl md:text-7xl lg:text-8xl'>
                        Best Washing with <span className='text-blue-600'>Fast</span> and <span className='text-blue-600'>Free</span> Delivery
                    </div>
                    <div className='mt-3 lg:mt-4 poppins-regular text-sm md:text-lg text-stone-600'>
                        <span className='font-semibold text-stone-700'>Law gate's first</span> and best laundry. <br /> Starting at just <span className='font-semibold text-stone-700'>25/- per kg</span>
                    </div>
